...
class VisitDraftResumeDialog {
  ...
  /// Entry point after kill/reopen.
  ///
  /// - 1 pending site → existing Continue / Submit / Discard dialog
  /// - 2+ pending sites → pick a site, then Continue / Submit / Discard
  ...
  static Future<VisitDraftResumeAction?> _showActionsForDraft(
    ...
    return GlassActionDialog.showWithActions<VisitDraftResumeAction>(
      ...
      actions: const [
        ...
        GlassDialogAction(
          label: 'Patrol completed upload report',
  ...
  /// Legacy single-draft helper (still used if callers pass one draft).
